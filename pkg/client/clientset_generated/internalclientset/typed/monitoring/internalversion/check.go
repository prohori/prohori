...
type CheckInterface interface {
	Create(*monitoring.Check) (*monitoring.Check, error)
	Update(*monitoring.Check) (*monitoring.Check, error)
	UpdateStatus(*monitoring.Check) (*monitoring.Check, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*monitoring.Check, error)
	List(opts v1.ListOptions) (*monitoring.CheckList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *monitoring.Check, err error)
	CheckExpansion
}
...
func newChecks(c *MonitoringClient, namespace string) *checks {
	return &checks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *checks) Get(name string, options v1.GetOptions) (result *monitoring.Check, err error) {
	result = &monitoring.Check{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("checks").
		Name(name).
...
func (c *checks) List(opts v1.ListOptions) (result *monitoring.CheckList, err error) {
	result = &monitoring.CheckList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("checks").
...
func (c *checks) Create(check *monitoring.Check) (result *monitoring.Check, err error) {
	result = &monitoring.Check{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("checks").
...
func (c *checks) Update(check *monitoring.Check) (result *monitoring.Check, err error) {
	result = &monitoring.Check{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("checks").
...
func (c *checks) UpdateStatus(check *monitoring.Check) (result *monitoring.Check, err error) {
	result = &monitoring.Check{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("checks").
...
func (c *checks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *monitoring.Check, err error) {
	result = &monitoring.Check{}
