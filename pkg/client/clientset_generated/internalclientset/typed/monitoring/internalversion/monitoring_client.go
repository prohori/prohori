...
import (
	"github.com/prohori/prohori/pkg/client/clientset_generated/internalclientset/scheme"
...
// MonitoringClient is used to interact with features provided by the monitoring.prohori group.
type MonitoringClient struct {
	restClient rest.Interface
}

func (c *MonitoringClient) Alerts(namespace string) AlertInterface {
...
func setConfigDefaults(config *rest.Config) error {
	g, err := scheme.Registry.Group("monitoring.prohori")
	if err != nil {
		return err
	}
