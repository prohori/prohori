...
import (
	...
	scheme "github.com/prohori/prohori/pkg/client/clientset_generated/internalclientset/scheme"
...
type AlertInterface interface {
	Create(*monitoring.Alert) (*monitoring.Alert, error)
	Update(*monitoring.Alert) (*monitoring.Alert, error)
	UpdateStatus(*monitoring.Alert) (*monitoring.Alert, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*monitoring.Alert, error)
	List(opts v1.ListOptions) (*monitoring.AlertList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *monitoring.Alert, err error)
	AlertExpansion
}
...
func newAlerts(c *MonitoringClient, namespace string) *alerts {
	return &alerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *alerts) Get(name string, options v1.GetOptions) (result *monitoring.Alert, err error) {
	result = &monitoring.Alert{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
		Name(name).
...
func (c *alerts) List(opts v1.ListOptions) (result *monitoring.AlertList, err error) {
	result = &monitoring.AlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Create(alert *monitoring.Alert) (result *monitoring.Alert, err error) {
	result = &monitoring.Alert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Update(alert *monitoring.Alert) (result *monitoring.Alert, err error) {
	result = &monitoring.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) UpdateStatus(alert *monitoring.Alert) (result *monitoring.Alert, err error) {
	result = &monitoring.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *monitoring.Alert, err error) {
	result = &monitoring.Alert{}
